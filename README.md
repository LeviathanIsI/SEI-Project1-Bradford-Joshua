...
1. Clone the repo <i>or</i> use the direct link in the "About" section
   ```sh
   git clone https://github.com/LeviathanIsI/SEI-Project1-Bradford-Joshua.git
   ```
2. If using the clone, open the project using index.html via Live Server
...
([Wireframe](https://www.figma.com/file/PdfQQCJLJiIcNHbsipb09V/P1---Simon-Says?type=design&node-id=0-1&mode=design&t=tEzWrxKwxTOcUhqu-0))
...
2. I wasn't able to implement a timer function, I couldn't get the timer to reset after each button click.
3. Along with the above, I wasn't able to implement a timer before the initial button press when entering the player sequence.
4. Implementing the sequence functionality was a little trickier than I expected but I was able to get it working after some research and testing.
